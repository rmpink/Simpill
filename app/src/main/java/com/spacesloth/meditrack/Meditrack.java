...
public class Meditrack extends Application {
    ...
    public Meditrack() {
        Thread.UncaughtExceptionHandler MEDITRACK_THREAD_EXCEPTION_HANDLER =
                (t, e) -> {
...
//                    errorReport.append("Time: ").append(ts);
        ...
        Thread.setDefaultUncaughtExceptionHandler(MEDITRACK_THREAD_EXCEPTION_HANDLER);
    }
